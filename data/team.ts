...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    title: 'Censeur',
    role: 'Censeur',
    description: 'Garante de la discipline, de la régularité et de la rigueur académique. Coordonne le bon déroulement des séances de travail et veille au respect des engagements.',
  ...
  },
  {
    ...
    role: 'Leader Cadets Techniciens',
    description: 'Guide et mentor des étudiants de la filière technologique. Accompagne les nouvelles promotions dans la maîtrise des matières appliquées et des projets techniques.',
