          ...
          <div className="flex items-center gap-3">
            ...
            {isLoggedIn ? (
              <div className="hidden md:flex items-center gap-2.5">
                ...
                <Link
                  href="/dashboard"
                  className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold text-sky-600 dark:text-sky-400 bg-sky-500/10 border border-sky-500/25 hover:bg-sky-500/20 transition-all"
                >
            ...
            {isLoggedIn ? (
              <>
                ...
                <Link
                  href="/dashboard"
                  onClick={() => setOpen(false)}
                  className="block px-4 py-3 rounded-xl text-sm text-sky-600 dark:text-sky-400 font-bold"
                >
                  Mon Espace Profil
                </Link>
                <button
